...
Console.WriteLine(firstNumber % secondNumber == 0? "Первое число кратно второму":$"Первое число некратно второму, остаток от деления равен = {firstNumber % secondNumber}");